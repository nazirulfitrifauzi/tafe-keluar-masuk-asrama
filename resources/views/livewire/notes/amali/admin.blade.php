<div class="flex flex-col p-6 h-full">
    ...
    <div>
        ...
        <div class="flex justify-between items-center mb-4">
            <div>
                <h2 class="text-lg font-medium text-gray-900">Practical Notes</h2>
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-3 py-3.5 text-sm font-semibold text-left text-gray-900">Link</th>
                                    ...
                                    @foreach ($chapterNotes as $note)
                                        <tr>
                                            ...
                                            <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">
                                                <a href="{{ $note->link }}" target="_blank" class="text-indigo-600 hover:text-indigo-900">View</a>
                                            </td>
        ...
        <!-- Remove pagination since we're showing all notes grouped by chapter -->
    </div>
        ...
        <x-card title="{{ $isEditing ? 'Edit Note' : 'Add New Note' }}" class="w-full min-w-[600px]">
            <div class="space-y-4">
                ...
                <div>
                    ...
                    />
                    @error('link') <span class="mt-1 text-sm text-red-600">{{ $message }}</span> @enderror
                </div>
            </div>
