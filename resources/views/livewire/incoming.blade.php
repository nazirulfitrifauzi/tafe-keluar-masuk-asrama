                        ...
                        <div>
                            ...
                            @if($status == 'sent')
                                <div class="mt-1 rounded-md shadow-sm">
                                    <input 
                                        type="text" 
                                        wire:model="inDateTime" 
                                        class="block px-3 py-2 w-full placeholder-gray-400 rounded-md border border-gray-300 transition duration-150 ease-in-out appearance-none focus:outline-none focus:ring-red-500 focus:border-red-300 sm:text-sm sm:leading-5" 
                                        disabled
                                    />
                                </div>
                            @else
                                <div class="mt-1 rounded-md shadow-sm" x-data="{ dateTime: new Date().toLocaleString() }" x-init="setInterval(() => dateTime = new Date().toLocaleString(), 1000)">
                                    <input type="text" x-model="dateTime" class="block px-3 py-2 w-full placeholder-gray-400 rounded-md border border-gray-300 transition duration-150 ease-in-out appearance-none focus:outline-none focus:ring-red-500 focus:border-red-300 sm:text-sm sm:leading-5" disabled />
                                </div>
                            @endif
                        </div>
                    </div>
